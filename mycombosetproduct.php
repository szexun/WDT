<?php
    ...
    $id = $_SESSION['id'];
    // sql query to retrieve comboset's data from database based on user's id
    $query = "SELECT * FROM `comboset` WHERE user_id = '$id'";
...
<body>  
    <h1><center>My Combo Set Product</center><br></h1>
    ...
    <div class="card column" style="width: 18rem;">
        ...
        <div class="card-body justify-content-center">
            ...
            <a href="editcombosetproduct.php?id=<?php echo($comboset_id[$i])?>" class="btn btn-primary">Edit Product</a>
            <a href="deletecombosetproduct.php?id=<?php echo($comboset_id[$i])?>" class="btn btn-danger">Delete Product</a>
        </div>
    </div>
    <?php  } ?>
</body>
